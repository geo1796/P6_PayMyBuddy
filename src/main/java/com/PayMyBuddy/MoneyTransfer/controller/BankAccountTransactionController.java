...
public class BankAccountTransactionController {
    ...
    public String addBankAccountTransaction(@ModelAttribute("bankAccountTransaction")BankAccountTransactionDto bankAccountTransaction, BindingResult result){
        ...
        if (result.hasErrors()){
            logger.error("can't proceed transaciton");
